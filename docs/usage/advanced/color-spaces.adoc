...
* link:/usage/basic/graphics-state/[Graphics State] - Color state management
* link:/usage/advanced/patterns/[Patterns] - Color patterns
* link:/commands/references/setrgbcolor/[setrgbcolor] - Set RGB color
* link:/commands/references/setcmykcolor/[setcmykcolor] - Set CMYK color
* link:/commands/references/setgray/[setgray] - Set gray color
* link:/commands/references/sethsbcolor/[sethsbcolor] - Set HSB color
* link:/commands/references/currentrgbcolor/[currentrgbcolor] - Get current RGB
