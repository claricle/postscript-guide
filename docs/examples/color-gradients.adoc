...
<2> Use [`setgray`](../commands/graphics-state/setgray.adoc) for grayscale (0=black, 1=white)
<3> Use [`setrgbcolor`](../commands/graphics-state/setrgbcolor.adoc) for red, green, blue (0.0-1.0 each)
<4> Use [`setcmykcolor`](../commands/graphics-state/setcmykcolor.adoc) for cyan, magenta, yellow, black
<5> Use [`sethsbcolor`](../commands/graphics-state/sethsbcolor.adoc) for hue (0-1 = 0-360°), saturation, brightness
...
<20> Use [`clip`](../commands/painting/clip.adoc) to restrict gradient to shape
<21> Use [`charpath`](../commands/font-text/charpath.adoc) to convert text to path
