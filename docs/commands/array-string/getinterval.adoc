...
[`getinterval`](getinterval.adoc) creates a new array, packed array, or string object whose value consists of _count_ elements starting at position _index_ in the original object.
