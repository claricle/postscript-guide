...
[`packedarray`](packedarray.adoc) creates a packed array object of length _n_ containing the objects any₀ through anyₙ₋₁ as elements. It:
...
WARNING: *Cannot Modify Packed Arrays* - Packed arrays are read-only. Attempting to use [`put`](put.adoc) or [`putinterval`](putinterval.adoc) causes [`invalidaccess`] error.
...
TIP: *Read Operations Work Normally* - Can use [`get`](get.adoc), [`getinterval`](getinterval.adoc), [`aload`](aload.adoc), [`forall`](forall.adoc), etc.
