...
* User dictionaries can be pushed/popped with [`begin`](begin.adoc) / [`end`](end.adoc)
...
WARNING: *Dictionary Stack Balance* - Every [`begin`](begin.adoc) must have matching [`end`](end.adoc). Unbalanced stacks cause [`dictstackunderflow`] or [`dictstackoverflow`].
