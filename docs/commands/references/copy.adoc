...
* link:/commands/references/dup/[`dup`] - Duplicate single element (reference only)
* link:/commands/[`index`] - Duplicate nth element
...
* link:/usage/basic/composite-objects/[Composite Objects] - Understanding object copying
