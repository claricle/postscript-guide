...
link:/commands/references/ueofill/[`ueofill`] is equivalent to:
...
WARNING: *Path Direction Irrelevant* - Unlike link:/commands/references/ufill/[`ufill`], path direction doesn't affect the result with link:/commands/references/ueofill/[`ueofill`].
...
TIP: *Ideal for Shapes with Holes* - Use link:/commands/references/ueofill/[`ueofill`] when you need predictable holes regardless of path direction:
...
.Standard fill (link:/commands/references/fill/[`fill`])
* Uses non-zero winding number rule
* Path direction matters
* No graphics state isolation

.Even-odd fill (link:/commands/references/eofill/[`eofill`])
* Uses even-odd rule
* Path direction doesn't matter
* No graphics state isolation

.User path fill (link:/commands/references/ufill/[`ufill`])
* Uses non-zero winding number rule
* Efficient user path format
* Automatic graphics state save/restore
* Can be cached

.User path even-odd fill (link:/commands/references/ueofill/[`ueofill`])
* Uses even-odd rule
* Efficient user path format
* Automatic graphics state save/restore
* Can be cached
...
* link:/commands/references/eofill/[`eofill`] - Even-odd fill traditional path
* link:/commands/references/ufill/[`ufill`] - Fill user path with non-zero winding rule
