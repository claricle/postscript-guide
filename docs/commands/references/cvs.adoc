...
link:/commands/references/cvs/[`cvs`] (convert to string) produces a text representation of an arbitrary object and stores it into the supplied _string_, overwriting an initial portion of its value. It returns a string object designating the substring actually used.
...
* link:/commands/references/cvn/[`cvn`] - Convert string to name
* link:/commands/references/cvi/[`cvi`] - Convert to integer
* link:/commands/references/cvr/[`cvr`] - Convert to real
* link:/commands/references/string/[`string`] - Create string buffer
