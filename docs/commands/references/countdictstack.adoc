...
link:/commands/references/countdictstack/[`countdictstack`] counts the number of dictionaries currently on the dictionary stack and pushes this count onto the operand stack.

The count includes all dictionaries: permanent system dictionaries and any pushed by link:/commands/references/begin/[`begin`].
...
* link:/commands/references/dictstack/[`dictstack`] - Copy dict stack to array
* link:/commands/references/begin/[`begin`] - Push dictionary
* link:/commands/references/end/[`end`] - Pop dictionary
* link:/commands/references/currentdict/[`currentdict`] - Get current dictionary
* link:/commands/references/count/[`count`] - Count operand stack depth