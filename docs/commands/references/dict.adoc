...
link:/commands/references/dict/[`dict`] creates an empty dictionary with an initial capacity of _int_ elements and pushes it onto the operand stack.
...
* link:/commands/references/begin/[`begin`] - Push dict onto dict stack
* link:/commands/references/end/[`end`] - Pop dict from dict stack
* link:/commands/references/def/[`def`] - Define entry in current dict
* link:/commands/references/maxlength/[`maxlength`] - Get maximum capacity
