...
* link:/commands/references/dup/[`dup`] - Duplicate top element before exchanging
* link:/commands/references/roll/[`roll`] - General stack rotation for multiple elements
* link:/commands/[`index`] - Access elements deeper in the stack
* link:/commands/references/pop/[`pop`] - Remove top element
* link:/commands/references/copy/[`copy`] - Copy multiple stack elements
