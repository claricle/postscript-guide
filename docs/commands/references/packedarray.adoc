...
link:/commands/references/packedarray/[`packedarray`] creates a packed array object of length _n_ containing the objects any₀ through anyₙ₋₁ as elements. It:
...
WARNING: *Cannot Modify Packed Arrays* - Packed arrays are read-only. Attempting to use link:/commands/references/put/[`put`] or link:/commands/references/putinterval/[`putinterval`] causes [`invalidaccess`] error.
...
TIP: *Read Operations Work Normally* - Can use link:/commands/references/get/[`get`], link:/commands/references/getinterval/[`getinterval`], link:/commands/references/aload/[`aload`], link:/commands/references/forall/[`forall`], etc.
...
* link:/commands/references/array/[`array`] - Create regular (modifiable) array
* link:/commands/references/brackets/[`[`] / link:/commands/references/brackets/[`]`] - Array literal syntax
* link:/commands/references/aload/[`aload`] - Load packed array elements
* link:/commands/references/get/[`get`] - Get packed array element
* link:/commands/references/forall/[`forall`] - Iterate over packed array