...
TIP: *Use ifelse for Two-Way* - For true/false cases, link:/commands/references/ifelse/[`ifelse`] is more convenient than nested `if` statements.
...
* link:/commands/references/ifelse/[`ifelse`] - Two-way conditional
