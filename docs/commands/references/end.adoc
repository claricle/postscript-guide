...
link:/commands/references/end/[`end`] pops the current dictionary off the dictionary stack, making the dictionary below it the new current dictionary.

If link:/commands/references/end/[`end`] attempts to pop the bottommost instance of `userdict`, it executes [`dictstackunderflow`] error. The permanent dictionaries (`systemdict`, `globaldict`, `userdict`) cannot be removed.
...
WARNING: *Unmatched end* - Executing link:/commands/references/end/[`end`] without matching link:/commands/references/begin/[`begin`] causes [`dictstackunderflow`].
