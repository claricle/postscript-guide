...
- Slightly slower than link:/commands/references/show/[`show`] due to conditional width adjustment
- Still benefits from font caching
- More efficient than link:/commands/references/kshow/[`kshow`] for simple spacing needs
...
- link:/commands/references/ashow/[`ashow`] - Show with uniform character spacing
