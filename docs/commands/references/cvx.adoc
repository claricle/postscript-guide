...
link:/commands/references/cvx/[`cvx`] (convert to executable) changes the attribute of the object on top of the operand stack from literal to executable.
...
* Complementary to link:/commands/references/cvlit/[`cvlit`]
