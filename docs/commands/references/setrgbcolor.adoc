...
link:/commands/references/setrgbcolor/[`setrgbcolor`] sets the color space to DeviceRGB and sets the current color using red, green, and blue components.
...
* link:/commands/references/setcmykcolor/[`setcmykcolor`] - Set CMYK (Level 2)
* link:/commands/references/sethsbcolor/[`sethsbcolor`] - Set HSB
