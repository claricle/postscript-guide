...
link:/commands/references/setdash/[`setdash`] sets the dash pattern parameter in the graphics state. This controls the pattern of dashes and gaps used by subsequent [`stroke`] operations.
...
The dash pattern is interpreted in user space and is unaffected by transformations applied after link:/commands/references/setdash/[`setdash`] is called.
...
* link:/commands/references/currentdash/[`currentdash`] - Get current dash pattern
...
* link:/commands/references/setlinejoin/[`setlinejoin`] - Set corner style
