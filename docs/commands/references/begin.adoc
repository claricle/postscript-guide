...
link:/commands/references/begin/[`begin`] pushes _dict_ onto the dictionary stack, making it the current dictionary. This dictionary becomes the first one consulted during:

* Implicit name lookup by the interpreter
* link:/commands/references/def/[`def`] - defines in current dictionary
* link:/commands/references/load/[`load`] - searches dictionary stack
* link:/commands/references/store/[`store`] - searches dictionary stack
* link:/commands/references/where/[`where`] - searches dictionary stack
...
WARNING: *Must Match with end* - Every link:/commands/references/begin/[`begin`] must have a corresponding link:/commands/references/end/[`end`]. Unmatched begins cause [`dictstackoverflow`].
...
* link:/commands/references/currentdict/[`currentdict`] - Get current dictionary
* link:/commands/references/def/[`def`] - Define in current dictionary
* link:/commands/references/dictstack/[`dictstack`] - Examine dictionary stack
* link:/commands/references/countdictstack/[`countdictstack`] - Count stack depth