...
* link:/commands/references/counttomark/[`counttomark`] - Count elements until a mark
...
* link:/commands/references/copy/[`copy`] - Copy n elements
* link:/commands/references/roll/[`roll`] - Rotate n elements
...
* link:/usage/debugging/[Debugging Guide] - Using count for debugging
