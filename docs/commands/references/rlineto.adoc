...
If the current point is undefined because the current path is empty, link:/commands/references/rlineto/[`rlineto`] executes the [`nocurrentpoint`] error.
...
WARNING: *Requires Current Point* - link:/commands/references/rlineto/[`rlineto`] requires an established current point. Use link:/commands/references/moveto/[`moveto`] first.
...
TIP: *Ideal for Regular Patterns* - link:/commands/references/rlineto/[`rlineto`] excels at creating regular, repeating patterns where each segment relates to the previous one.
...
* Successive link:/commands/references/rlineto/[`rlineto`] calls build polylines efficiently
* Negative displacements move backward or downward

=== Performance Considerations

* No performance difference from link:/commands/references/lineto/[`lineto`]
...
* link:/commands/references/lineto/[`lineto`] - Absolute lineto
