...
link:/commands/references/currentrgbcolor/[`currentrgbcolor`] returns the current color in the graphics state according to the red-green-blue color model.

* If the current color space is **DeviceRGB**,
link:/commands/references/currentrgbcolor/[`currentrgbcolor`] returns the color values most
recently specified to link:/commands/references/setrgbcolor/[`setrgbcolor`] or [`setcolor`]
(or transformed values specified to link:/commands/references/sethsbcolor/[`sethsbcolor`]) .

* If the current color space is **DeviceGray** or **DeviceCMYK**, link:/commands/references/currentrgbcolor/[`currentrgbcolor`] converts the current color to RGB.
* For any other color space, link:/commands/references/currentrgbcolor/[`currentrgbcolor`] returns **0.0 0.0 0.0** (black).
