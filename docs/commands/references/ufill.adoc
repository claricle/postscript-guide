...
link:/commands/references/ufill/[`ufill`] is equivalent to:
...
WARNING: *Graphics State Not Modified* - link:/commands/references/ufill/[`ufill`] automatically saves and restores the graphics state.
...
.User path approach (link:/commands/references/ufill/[`ufill`])
[source,postscript]
----
[
  50 50 250 250 setbbox
...
* link:/commands/references/fill/[`fill`] - Traditional fill operator
* link:/commands/references/ueofill/[`ueofill`] - Even-odd fill user path
