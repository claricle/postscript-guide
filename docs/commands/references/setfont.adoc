...
link:/commands/references/setfont/[`setfont`] only modifies the font parameter of the graphics state. It does not affect:
...
- link:/commands/references/show/[`show`] - Paint text string at current point
