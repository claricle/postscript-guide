...
This operator is essential for implementing variable-argument procedures where the number of arguments is not known in advance. It's commonly used with link:/commands/references/mark/[`mark`] to process all elements in a marked segment.
...
* link:/commands/references/cleartomark/[`cleartomark`] - Remove elements down to and including mark
* link:/commands/references/count/[`count`] - Count total stack depth
* `]` - Create array from marked elements
...
1. **Use with mark**: Always ensure a link:/commands/references/mark/[`mark`] exists before calling `counttomark`
...
* link:/usage/basic/procedures/[Procedures] - Implementing variable-argument functions
