...
link:/commands/references/findfont/[`findfont`] is not an operator, but rather a built-in procedure. It may be redefined by a PostScript language program that requires different strategies for finding fonts.
...
1. **Local VM fonts** - Defined by link:/commands/references/definefont/[`definefont`] in local VM
2. **Global VM fonts** - Defined by link:/commands/references/definefont/[`definefont`] in global VM
...
- link:/commands/references/scalefont/[`scalefont`] - Scale font by uniform factor
- link:/commands/references/makefont/[`makefont`] - Transform font by matrix
- link:/commands/references/setfont/[`setfont`] - Establish current font
- link:/commands/references/definefont/[`definefont`] - Register font in font directory
