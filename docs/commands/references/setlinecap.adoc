...
link:/commands/references/setlinecap/[`setlinecap`] sets the line cap parameter to _int_, which must be 0, 1, or 2. This controls the shape of line ends for open subpaths painted by [`stroke`].
...
* link:/commands/references/currentlinecap/[`currentlinecap`] - Get current cap
