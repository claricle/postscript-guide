...
link:/commands/references/get/[`get`] retrieves a single element from a composite object:
...
WARNING: *String Returns Integer* - link:/commands/references/get/[`get`] on a string returns an integer (character code), not a one-character string.
...
TIP: *Use known/where First* - For dictionaries, use `where` or `known` to check if a key exists before using link:/commands/references/get/[`get`].
...
* For sequential access, link:/commands/references/forall/[`forall`] may be more efficient than repeated link:/commands/references/get/[`get`] calls

=== See Also

* link:/commands/references/put/[`put`] - Store value in array/string/dictionary
* link:/commands/references/getinterval/[`getinterval`] - Get subarray or substring
* link:/commands/references/length/[`length`] - Get length of array/string
* link:/commands/references/aload/[`aload`] - Load all array elements
* link:/commands/references/forall/[`forall`] - Iterate over elements