...
With no matrix operand, link:/commands/references/transform/[`transform`] transforms the user space coordinate (x, y) by the current transformation matrix (CTM) to produce the corresponding device space coordinate (x', y').

If the `matrix` operand is supplied, link:/commands/references/transform/[`transform`] transforms (x, y) by `matrix` rather than by the CTM.
...
WARNING: *Position-Dependent* - link:/commands/references/transform/[`transform`] includes translation. Use link:/commands/references/dtransform/[`dtransform`] for distances.
...
TIP: *Use for Debugging* - link:/commands/references/transform/[`transform`] helps understand coordinate mappings:
...
* The inverse operation is link:/commands/references/itransform/[`itransform`]
...
* link:/commands/references/itransform/[`itransform`] - Inverse coordinate transformation (device to user)
* link:/commands/references/dtransform/[`dtransform`] - Distance vector transformation
...
* link:/commands/references/concat/[`concat`] - Modify CTM