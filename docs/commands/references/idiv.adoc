...
For division that preserves fractional parts, use link:/commands/references/div/[`div`]. For the remainder of integer division, use link:/commands/references/mod/[`mod`].
...
* link:/commands/references/div/[`div`] - Division with real result
...
* link:/commands/references/truncate/[`truncate`] - Truncate real to integer
