...
Like link:/commands/references/fill/[`fill`], link:/commands/references/eofill/[`eofill`] implicitly closes any open subpaths before painting and performs a link:/commands/references/newpath/[`newpath`] after completion.
...
WARNING: *Different Results from fill* - The even-odd rule produces different results than the non-zero winding number rule used by link:/commands/references/fill/[`fill`].
...
WARNING: *Path Direction Irrelevant* - Unlike link:/commands/references/fill/[`fill`], the direction paths are drawn doesn't matter with link:/commands/references/eofill/[`eofill`].
...
TIP: *Use for Shapes with Holes* - link:/commands/references/eofill/[`eofill`] is ideal for shapes with holes, regardless of path direction:
...
.Even-Odd Rule (link:/commands/references/eofill/[`eofill`])
...
.Non-Zero Winding Rule (link:/commands/references/fill/[`fill`])
...
* link:/commands/references/fill/[`fill`] - Fill using non-zero winding rule
* link:/commands/references/eoclip/[`eoclip`] - Clip using even-odd rule
* link:/commands/references/ueofill/[`ueofill`] - Even-odd fill user path (Level 2)
